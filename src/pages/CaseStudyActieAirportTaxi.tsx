...
export default function CaseStudyActieAirportTaxi() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-6 py-24 space-y-24">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 max-w-xl">
            ...
            <div className="space-y-1">
              ...
              <p className="text-green-400 font-semibold">Live — actively taking bookings</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl overflow-hidden border border-white/10">
          <img
            ...
            alt="Actie Airport Taxi website screenshot"
        ...
        <div className="space-y-6">
          ...
          <p className="text-xl md:text-2xl text-[#7D8590] leading-relaxed max-w-3xl">
            Actie Airport Taxi needed a professional website to establish their online presence and convert
            visitors into airport transfer bookings. The goal was a clean, trustworthy site with fixed
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { label: 'Built with', value: 'Bolt.new (React)' },
              { label: 'Styling', value: 'Tailwind CSS' },
              { label: 'Deployment', value: 'Vercel' },
              { label: 'Payments', value: 'Mollie' },
              { label: 'Booking', value: 'Custom booking flow' },
            ].map((item) => (
              <div
                key={item.label}
            ...
            {[
              {
                step: 'Step 1 — Brief',
                days: 'Day 1',
                body: 'Mapped out the service offering: fixed pricing, pre-booking only, national coverage. Target audience: travelers needing reliable airport transfers.',
              },
              {
                step: 'Step 2 — Build',
                days: 'Days 2–6',
                body: 'Built the full site: hero with booking CTA, fixed pricing display, city coverage pages, and automated confirmation system.',
              },
              {
                step: 'Step 3 — Launch',
                days: 'Day 7',
                body: 'Site went live. Now actively taking bookings with automated confirmations.',
              },
            ].map((item, idx) => (
              <div
                key={idx}
        ...
        >
          ...
          <p className="text-2xl md:text-3xl font-black text-white">
            "A live airport taxi booking site serving customers across the Netherlands —
            155+ five-star Google reviews and growing."
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-white/10 pt-12">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <a
              href="https://actieairporttaxi.nl"
              target="_blank"
